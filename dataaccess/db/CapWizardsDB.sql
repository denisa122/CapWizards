...
(NULL, "Coca-Cola Black", "Coca-Cola Black bottle cap crafted with precision and attention to every detail. Characteristic black color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Coca Cola", "Black", "1", "/Assets/img/coca-cola/Coca-cola_black.png", "coca-cola black bottle cap", "metal", "2", NULL),
(NULL, "Sprite Original", "Sprite Original bottle cap crafted with precision and attention to every detail. Characteristic green color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Sprite", "Green", "1", "/Assets/img/sprite/Sprite_oryginal.png", "sprite original green bottle cap", "metal", "2", NULL),
(NULL, "Sprite Blue", "Sprite blue bottle cap crafted with precision and attention to every detail. Characteristic blue color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Sprite", "Blue", "1", "/Assets/img/sprite/Sprite_blue.png", "sprite blue bottle cap", "metal", "2", NULL),
(NULL, "Sprite purple", "Sprite purple bottle cap crafted with precision and attention to every detail. Characteristic purple color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Sprite", "Purple", "1", "/Assets/img/sprite/Sprite_purple.png", "sprite purple bottle cap", "metal", "2", NULL),
(NULL, "Breezer Original", "Breezer Original bottle cap crafted with precision and attention to every detail. Characteristic silver color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Breezer", "Silver", "1", "/Assets/img/breezer/Breezer_oryginal.png", "breezer original bottle cap", "metal", "1", 3),
(NULL, "Corona Original", "Corona Original bottle cap crafted with precision and attention to every detail. Characteristic navy blue color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Corona", "Navy blue", "1", "/Assets/img/corona/Corona_oryginal.png", "Corona original bottle cap", "metal", "1", 2),
(NULL, "Corona Green", "Corona green bottle cap crafted with precision and attention to every detail. Characteristic green color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Corona", "Green", "1", "/Assets/img/corona/Corona_green.png", "Corona green bottle cap", "metal", "1", 2),
(NULL, "Corona Red", "Corona red bottle cap crafted with precision and attention to every detail. Characteristic red color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Corona", "Red", "1", "/Assets/img/corona/Corona_red.png", "Corona red bottle cap", "metal", "1", 2),
(NULL, "Jul Original", "Jul Original bottle cap crafted with precision and attention to every detail. Characteristic white and red color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Jul", "White/Red", "1", "/Assets/img/jul/Jul_oryginal.png", "Jul original bottle cap", "metal", "1", 2),
(NULL, "Jul Blue", "Jul blue bottle cap crafted with precision and attention to every detail. Characteristic blue color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Jul", "Blue", "1", "/Assets/img/jul/Jul_blue.png", "Jul blue bottle cap", "metal", "1", 2),
(NULL, "Jul Green", "Jul green bottle cap crafted with precision and attention to every detail. Characteristic green color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Jul", "Green", "1", "/Assets/img/jul/Jul_green.png", "Jul green bottle cap", "metal", "1", 2),
(NULL, "Skovlyst Original", "Skovlyst original bottle cap crafted with precision and attention to every detail. Characteristic blue color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Skovlyst", "Blue", "1", "/Assets/img/skovlyst/Skovlyst_oryginal.png", "Skovlyst oryginal bottle cap", "metal", "1", 2),
(NULL, "Skovlyst Green", "Skovlyst green bottle cap crafted with precision and attention to every detail. Characteristic green color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Skovlyst", "Green", "1", "/Assets/img/skovlyst/Skovlyst_green.png", "Skovlyst green bottle cap", "metal", "1", 2),
(NULL, "Skovlyst Red", "Skovlyst red bottle cap crafted with precision and attention to every detail. Characteristic red color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Skovlyst", "Red", "1", "/Assets/img/skovlyst/Skovlyst_red.png", "Skovlyst red bottle cap", "metal", "1", 2),
(NULL, "Tuborg Original", "Tuborg original bottle cap crafted with precision and attention to every detail. Characteristic black color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Tuborg", "Black", "1", "/Assets/img/tuborg/Tuborg_oryginal.png", "Tuborg oryginal bottle cap", "metal", "1", 2),
(NULL, "Tuborg Green", "Tuborg green bottle cap crafted with precision and attention to every detail. Characteristic green color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Tuborg", "Green", "1", "/Assets/img/tuborg/Tuborg_green.png", "Tuborg green bottle cap", "metal", "1", 2),
(NULL, "Tuborg Red", "Tuborg red bottle cap crafted with precision and attention to every detail. Characteristic red color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Tuborg", "Red", "1", "/Assets/img/tuborg/Tuborg_red.png", "Tuborg red bottle cap", "metal", "1", 2),
(NULL, "Tuborg Gron Original", "Tuborg Gron original bottle cap crafted with precision and attention to every detail. Characteristic silver color and standard bottle cap size, a universal fit for most beverage containers and collections. Each cap is in spotless condition.", "100", "32", "Tuborg Gron", "Silver", "1", "/Assets/img/tuborg_gron/Tuborg-Gron_otyginal.png", "Tuborg Gron oryginal bottle cap", "metal", "1", 2);
